                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="focus:border-b-primary w-full border-b py-3 pr-6 pl-12 text-gray-900 placeholder-gray-500 focus:outline-none"
                    />
                  </div>
                </div>
                <button
                  ...
                  className="bg-primary hover:bg-primary/90 focus:ring-primary flex items-center gap-2 rounded-lg px-6 py-3 font-semibold text-white transition-all duration-200 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                >
                          ...
                          <div className="flex flex-1 items-center gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="mt-1 flex items-center gap-2 text-sm text-gray-500">
                                ...
                                <span>
                                  {formatClock(transaction.created_at)}
                                </span>
                              </div>
                            </div>
                          </div>
...
const navItems = [
  ...
  { to: "/employee/orders", label: "History", icon: <ClipboardClock /> },
  { to: "/employee/orders", label: "Orders", icon: <ShoppingBag /> },
  { to: "/employee/orders", label: "Return Orders", icon: <Undo2 /> },
];
