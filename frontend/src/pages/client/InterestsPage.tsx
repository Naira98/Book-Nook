...
const SelectInterests = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center px-4 pt-30 pb-12 sm:px-6">
      ...
      <img
        alt="logo"
        className="absolute top-4 left-4 w-22 sm:block md:absolute md:top-4 md:left-4 md:w-28 lg:w-30"
      ...
      >
        <h1 className="text-primary mb-2 text-center text-2xl font-bold sm:text-3xl">
              ...
              <motion.button
                ...
                className={`relative flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 px-3 py-5 text-sm font-medium shadow-md transition-all duration-300 sm:px-4 sm:py-6 sm:text-lg ${
                  isSelected
                    ...
                    : "hover:border-accent border-gray-200 bg-white text-gray-700 hover:bg-gray-50"
                }`}
              >
                {/* Icon */}
                <Icon
