...
from crud.promo_code import get_promo_codes, create_promo_code, update_promo_code
from schemas.promo_code import promoCodeSchema, PromoCodeCreate, PromoCodeUpdate
...
async def update_existing_promo_code(
    promo_code_id: int, promo_code_data: PromoCodeUpdate, db: AsyncSession = Depends(get_db)
):
