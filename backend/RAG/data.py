...
from crud.book import fetch_books_from_api , get_all_books
from langchain_core.prompts import ChatPromptTemplate
from langchain.chains import create_retrieval_chain
from langchain.chains.combine_documents import create_stuff_documents_chain
from langchain_core.documents import Document
import logging
from db.database import get_db,get_db_sync
import asyncio
...
if CONNECTION_STRING.startswith("postgresql+asyncpg"):
    CONNECTION_STRING = CONNECTION_STRING.replace("postgresql+asyncpg", "postgresql+psycopg2")
...
async def build_or_update_index_async(api_url="http://127.0.0.1:8000/api/books/", clear_existing=False):
