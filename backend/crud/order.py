...
async def get_order_details_crud(
    db: AsyncSession,
    user: User,
    order_id: int,
):
...
async def get_order_details_for_staff_crud(
    db: AsyncSession, staff_user: User, order_id: int
):
...
async def update_order_status_crud(
    db: AsyncSession, staff_user: User, order_data: UpdateOrderStatusRequest
):
    try:
        query = (
            select(Order)
...
async def update_borrow_order_book_problem_crud(
    db: AsyncSession,
    user: User,
